...
public class StudentFeeForm extends JFrame implements ActionListener{
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] { "Computer Science","Science","Arts","Commerce","Management" }));
	...
	comboBox_3.setModel(new DefaultComboBoxModel(
			new String[] { "B.A","B.Sc.","B.Sc. Computer","B.Com","B.B.A","M.A","M.Sc.","M.Sc. Computer","M.Com","M.B.A" }));
