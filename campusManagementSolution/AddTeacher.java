...
class AddTeacher implements ActionListener{
    ...
    AddTeacher(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon("D://image_icons/fifth.jpg");
	...
	lab.setFont(new Font("serif",Font.BOLD,20));
        ...
        String course[] = {"M.Tech","M.Sc Computer","MCA","M.Sc","M.A.","MBA","M.Com"};
	...
	lab2.setFont(new Font("serif",Font.BOLD,20));
        ...
        String dept[] = {"Computer Science","Physics","Chemistry","Electronics","Accounting","Hindi","Marathi","Economics","Politics","Marketing"};
